...
public interface Epic<S> {
   ...
   * @param stateProvider A function which returns the State of our redux implementation. You'll want it to be the method for fetching state from the store, probably.
